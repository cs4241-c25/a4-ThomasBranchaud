import './App.css'
import submitEntry from "../public/Scripts/submitEntry.js";
...
function GameEntry(){
    return (
        <>
            ...
            <form id="form" className="mainForm">
                <div>
                    ...
                    <input type="text" id="title"
                           className="bg-gray-50 border border-gray-300 text-white-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 max-w-96"
                ...
                <select id="online"
                        className="bg-gray-50 border border-gray-300 text-white-900 text-base rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray dark:focus:ring-blue-500 dark:focus:border-blue-500 max-w-96">
                ...
                <br/>
                <div className="ml-13">
                    <button type="button" className="text-gray-900 bg-gradient-to-r from-red-200 via-red-300 to-yellow-200 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-100 dark:focus:ring-red-400 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2" id="submitButton" onClick={submitEntry}>Submit
                    </button>
                </div>
            </form>
            <br/><br/>
            <hr className="h-px my-8 bg-gray-200 border-0 dark:bg-gray-700"/>
            <br/>
            <script src="/Scripts/submitEntry.js"/>
        </>
    )
}
